...
CREATE TABLE Hub(
                    hubId       INTEGER         CONSTRAINT pk_Hub_idHub PRIMARY KEY,
                    tipoHub     VARCHAR(30)     CONSTRAINT ck_Hub_tipoHub CHECK (tipoHub IN ('C', 'E', 'P'))
);
...
CREATE TABLE DadosNegocio (
                              ...
                              CONSTRAINT fk_BusinessDate_hubId_Hub                    FOREIGN KEY (hubId)                     REFERENCES Hub(hubId)
);
